...
export function rawGetResults(skip = 0, limit = 36, search = "", sort = "newest") {
...
export const rawGetResultById = (id) => client.get(`/results/${id}`);

export async function rawSaveResult(resultData) {
	try {
