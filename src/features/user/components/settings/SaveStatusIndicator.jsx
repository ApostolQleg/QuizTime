...
export default function SaveStatusIndicator() {
	...
	return (
		<div
			className={`min-w-15 rounded-full border px-4 py-2 text-xs font-semibold tracking-wide shadow-lg backdrop-blur-md transition-all duration-300 ${meta.className}`}
		>
			{status === "saving" ? (
