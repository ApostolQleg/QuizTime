				...
				<div className="space-y-8 text-(--col-text-main)">
					<section>
						...
						<p className="mb-2">
							...
							<span className="font-bold">Quizzes</span> page, browse the collection
							and click on any card to view details.
						</p>
					...
					<section>
						...
						<ul className="list-disc list-inside pl-2 sm:pl-4 opacity-90 space-y-1 marker:text-(--col-primary)">
							...
							<li>
								<span className="font-bold text-white">Registered Users:</span> All
								your attempts are saved to the{" "}
								<span className="font-bold">Results</span> page. You can track your
								progress and see exactly when you took each quiz.
							</li>
						</ul>
					</section>
					...
					<section>
						...
						<ul className="list-disc list-inside pl-2 sm:pl-4 opacity-90 space-y-1 marker:text-(--col-primary)">
							...
							<li>
								...
								and add as many questions as you like.
							</li>
							<li>
								<strong>Manage:</strong> If you are the author of a quiz, you can
								open its details card to{" "}
